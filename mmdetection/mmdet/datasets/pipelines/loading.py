...
class LoadImageFromFile(object):
    ...
    def __init__(self, to_float32=False, color_type='color', width=-1, height=-1):
    ...
    def __call__(self, results):
        ...
        if self.width != -1 and self.height != -1:
            ...
            if img_width < self.width:
                img = cv2.copyMakeBorder(img, 0, 0, 0, self.width-img_width, cv2.BORDER_CONSTANT, value=(0,0,0))
            if img_height < self.height:
                img = cv2.copyMakeBorder(img, 0, self.height-img_height, 0, 0, cv2.BORDER_CONSTANT, value=(0,0,0))
